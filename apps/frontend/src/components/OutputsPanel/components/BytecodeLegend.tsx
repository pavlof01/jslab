...
const COLUMNS: { sample: string; meaning: string }[] = [
  ...
  {
    sample: "0x2a1b…",
    meaning: "Address of the bytecode array in the heap — differs on every run.",
  },
  {
    sample: "@ 0",
    meaning: "Offset of this instruction inside the bytecode array; jumps target these.",
  },
  { sample: "0b 03", meaning: "Raw bytes: the opcode followed by its operands." },
  {
    sample: "Ldar a1",
    meaning: "Mnemonic and operands — aN parameters, rN registers, [n] pool slots.",
  },
];
    ...
    >
      <Flex wrap="wrap" align="baseline" justify="space-between" gap="4px 14px" mb="7px">
        ...
        <Button
          ...
          aria-label="Dismiss bytecode legend"
        >
          ×
        </Button>
      </Flex>
