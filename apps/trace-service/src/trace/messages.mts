...
import type { ArrayBufferObject, FunctionObject } from './index.mts';
...
export const InvalidCalendar = (id: string) => `Invalid calendar: ${i(id)}`;
...
export const MissingRequiredField = (f: string) => `Missing required field: ${f}`;
...
export const NoFieldsPresent = () => 'No fields present';
...
export const NotAnInteger = (v: Value) => `${i(v)} is not an integer`;
