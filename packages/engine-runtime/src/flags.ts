...
export const flagCatalog: Record<CatalogEngine, readonly FlagSpec[]> = {
  v8: [
    ...
    {
      flag: "--no-liftoff",
      description: "Skip the Liftoff wasm baseline tier; compile with TurboFan directly.",
      category: "wasm",
    },
    {
      flag: "--no-wasm-async-compilation",
      description: "Compile WebAssembly synchronously so output stays ordered.",
      category: "wasm",
    },
    {
      flag: "--print-all-code",
      description: "Dump every code object V8 generates (very large output).",
      category: "codegen",
    },
    {
      flag: "--print-all-exceptions",
      description: "Print every thrown exception, including caught ones.",
    ...
    {
      flag: "--print-break-location",
      description: "Print source positions used as debugger break locations.",
      category: "diagnostics",
    },
    {
      flag: "--print-builtin-code",
      description: "Disassemble V8's built-in code objects.",
      category: "codegen",
    },
    {
      flag: "--print-builtin-size",
      description: "Report the code size of each built-in.",
      category: "codegen",
    },
    {
      flag: "--print-bytecode",
      description: "Print Ignition bytecode for every compiled function.",
      category: "bytecode",
    },
    {
    ...
    {
      flag: "--print-code",
      description: "Disassemble generated machine code.",
      category: "codegen",
    },
    {
      flag: "--print-code-verbose",
      description: "Disassemble generated code with relocation and metadata detail.",
      category: "codegen",
    },
    {
      flag: "--print-deopt-stress",
      description: "Print deoptimization points visited under deopt stress.",
      category: "optimization",
    },
    {
      flag: "--print-flag-values",
      description: "Print every V8 flag and its effective value.",
      category: "diagnostics",
    },
    {
      flag: "--print-maglev-code",
      description: "Disassemble code produced by the Maglev mid-tier compiler.",
      category: "optimization",
    },
    {
      flag: "--print-maglev-deopt-verbose",
      description: "Explain each Maglev deoptimization in detail.",
      category: "optimization",
    },
    {
      flag: "--print-maglev-graph",
      description: "Print the Maglev IR graph.",
      category: "optimization",
    },
    {
      flag: "--print-maglev-graphs",
      description: "Print the Maglev IR graph after each phase.",
      category: "optimization",
    },
    {
      flag: "--print-opt-code",
      description: "Disassemble optimized (TurboFan) code.",
      category: "optimization",
    },
    {
      flag: "--print-opt-source",
      description: "Print the source of functions that get optimized.",
      category: "optimization",
    },
    {
      flag: "--print-regexp-bytecode",
      description: "Print the bytecode of the regexp interpreter.",
      category: "regexp",
    },
    {
      flag: "--print-regexp-code",
      description: "Disassemble compiled regexp code.",
      category: "regexp",
    },
    {
      flag: "--print-regexp-graph",
      description: "Print the regexp compiler's graph.",
      category: "regexp",
    },
    {
      flag: "--print-scopes",
      description: "Print the scope chain the parser built.",
      category: "parser",
    },
    {
      flag: "--print-turbolev-frontend",
      description: "Print the Turbolev frontend graph.",
      category: "optimization",
    },
    {
      flag: "--print-turbolev-inline-functions",
      description: "Print functions inlined by Turbolev.",
      category: "optimization",
    },
    {
      flag: "--print-wasm-code",
      description: "Disassemble compiled WebAssembly code.",
      category: "wasm",
    },
    {
      flag: "--print-wasm-stub-code",
      description: "Disassemble WebAssembly stub code.",
      category: "wasm",
    },
    {
      flag: "--trace-deopt",
      description: "Log every deoptimization with its reason.",
      category: "optimization",
    },
    {
      flag: "--trace-ic",
      description: "Log inline-cache state transitions (monomorphic → polymorphic → megamorphic).",
      category: "inline-caches",
    },
    {
      flag: "--trace-ignition",
      description: "Trace bytecode execution in the Ignition interpreter.",
      category: "bytecode",
    },
    {
      flag: "--trace-maps",
      description: "Log hidden-class (Map) creation and transitions.",
      category: "object-shapes",
    },
    {
      flag: "--trace-maps-details",
      description: "Log hidden-class transitions with per-property detail.",
      category: "object-shapes",
    },
    {
      flag: "--trace-opt",
      description: "Log which functions get optimized and when.",
      category: "optimization",
    },
    {
      flag: "--trace-opt-verbose",
      description: "Log optimization decisions with the reasoning behind them.",
      category: "optimization",
    },
  ],
  hermes: [
    {
      flag: "-O",
      description: "Enable Hermes optimizations before emitting bytecode.",
      category: "optimization",
    },
    {
      flag: "-gc-sanitize-handles",
      description: "Move objects on every allocation to surface handle bugs.",
      category: "gc",
    },
  ...
  sm: [
    {
      flag: "--baseline-eager",
      description: "Compile with the Baseline JIT immediately instead of after warm-up.",
      category: "optimization",
    },
    {
      flag: "--ion-eager",
      description: "Compile with the IonMonkey optimizing JIT immediately.",
      category: "optimization",
    },
  ],
  jsc: [
    { flag: "-d", description: "Dump JSC bytecode for the compiled script.", category: "bytecode" },
  ],
};
