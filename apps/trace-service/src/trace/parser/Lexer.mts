...
export abstract class Lexer {
  ...
  abstract createSyntaxError<K extends keyof typeof import('../messages.mts')>(context: number | Locatable | undefined, template: K, templateArgs: Parameters<typeof import('../messages.mts')[K]>): SyntaxError;

  abstract raiseEarly<K extends keyof typeof import('../messages.mts')>(template: K, context?: number | Locatable, ...templateArgs: Parameters<typeof import('../messages.mts')[K]>): SyntaxError;

  abstract raise<K extends keyof typeof import('../messages.mts')>(template: K, context?: number | Locatable, ...templateArgs: Parameters<typeof import('../messages.mts')[K]>): never;

  abstract unexpected(...args: [(number | Locatable)?, ...Parameters<typeof import('../messages.mts')['UnexpectedToken']>]): never;
